 ...
 * @author Home
 */
public class ModelGRates {
   public void statusComboG(JComboBox combo1)
            {
     ...
     public void statusComboG1(JComboBox combo1)
            {
             Connection con = ModelLogin.getConnection();
        try {
     ...
     public void statusComboG3(JComboBox combo1)
            {
             Connection con = ModelLogin.getConnection();
        try {
            PreparedStatement ps=con.prepareStatement("SELECT description FROM `get_rates`");
            ResultSet rs = ps.executeQuery();
