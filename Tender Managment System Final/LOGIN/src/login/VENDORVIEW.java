 ...
 * @author Vik
 */
public class VENDORVIEW extends javax.swing.JFrame {
    Connection con;
...
//  
     ...
     public void fillClientjTable(JTable table,String valueToSearch)
        ...
        try { 
            PreparedStatement ps=con.prepareStatement("SELECT `vendorid`, `name`, `contact`, `address` FROM `vendor` WHERE CONCAT(`vendorid`, `name`, `contact`, `address`)LIKE ?");
    ...
    private void initComponents() {
        ...
        jButton2.setBounds(1020, 300, 73, 23);
        ...
        jButton14.setBounds(1110, 300, 73, 23);
        ...
        Vendor_Name.setBounds(500, 230, 370, 20);
        ...
        jTextField_Val_Find.setBounds(520, 110, 370, 20);
        ...
        Vendor_Image.setBounds(930, 80, 220, 200);
        ...
        jLabel19.setBounds(310, 230, 150, 20);
        ...
        jScrollPane1.setBounds(280, 370, 810, 400);
        ...
        jLabel15.setBounds(310, 310, 150, 20);
        ...
        jLabel17.setBounds(310, 190, 150, 20);
        ...
        jLabel18.setBounds(310, 270, 150, 20);

        Vendor_Id.setBackground(new java.awt.Color(51, 51, 51));
        Vendor_Id.setFont(new java.awt.Font("Tw Cen MT", 1, 14)); // NOI18N
        Vendor_Id.setForeground(new java.awt.Color(255, 255, 255));
        Vendor_Id.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        Vendor_Id.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 255, 255)));
        ...
        Vendor_Id.setBounds(500, 190, 370, 20);
        ...
        Vendor_Contact.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                Vendor_ContactKeyTyped(evt);
            }
        });
        jPanel1.add(Vendor_Contact);
        Vendor_Contact.setBounds(500, 270, 370, 20);
        ...
        Vendor_Address.setBounds(500, 310, 370, 20);
        ...
        jButton20.setText("GENERATE VENDORS REPORT");
        ...
        jButton20.setBounds(930, 340, 250, 23);
    ...
    private void Vendor_ContactKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Vendor_ContactKeyTyped

    }//GEN-LAST:event_Vendor_ContactKeyTyped
...
int rowIndex;
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        Vendor_Id.setText(model.getValueAt(rowIndex, 0).toString());
        Vendor_Name.setText(model.getValueAt(rowIndex, 1).toString());
        Vendor_Contact.setText(model.getValueAt(rowIndex, 2).toString());
        Vendor_Address.setText(model.getValueAt(rowIndex,3).toString());
        Connection con = ModelLogin.getConnection();
         
        try {
             ps=con.prepareStatement("SELECT `image` FROM `vendor` WHERE `vendorid` =?");
             ps.setString(1,Vendor_Id.getText());
            rs=ps.executeQuery();
            while(rs.next())
            {
    ...
    private void jTextField_Val_FindKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField_Val_FindKeyReleased
        jTable1.setModel(new DefaultTableModel(null , new Object[]{"Id","Name","Contact","Address"}));
        fillClientjTable(jTable1, jTextField_Val_Find.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
           ...
           || Vendor_Image.getIcon().equals(null) || Vendor_Id.getText().equals(""))
        {
      ...
      try 
            {
                ...
                ps = con.prepareStatement("UPDATE `vendor` SET `name` = ?,`address` = ?,`image` = ? WHERE `vendorid` = ? ");
                if(imgpath != null){ 
                ...
                ps.executeUpdate();
                     ...
                     JOptionPane.showMessageDialog(null, "Vendor Data Updated Successfully");
                
            } catch (Exception ex) {
                JOptionPane.showMessageDialog(null, "Vendor Update Query Not Executed Successfully"+ex);
            } 
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
           ...
           || Vendor_Image.getIcon().equals(null) || Vendor_Id.getText().equals(""))
        {
           JOptionPane.showMessageDialog(null, "Please Fill All The Details");
             ...
             {
    Connection con = ModelLogin.getConnection();
    int yesOrNo = JOptionPane.showConfirmDialog(null,  "Are you Sure you want to delete?" , "Delete Vendor",JOptionPane.OK_CANCEL_OPTION,0);
            
            if(yesOrNo == JOptionPane.OK_OPTION)
            {       
 try 
            {
                ps = con.prepareStatement("DELETE FROM `vendor` WHERE `vendorid` = ?");
                ps.setString(1, Vendor_Id.getText()); 
                if(ps.executeUpdate()>0)
                {
                     JOptionPane.showMessageDialog(null, "Vendor Data Deleted Successfully");
                }
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Vendor Delete Query Not Executed Successfully");
            }}
        fillClientjTable(jTable1,"");
        jTable1.setModel(new DefaultTableModel(null , new Object[]{"Id","Name","Contact","Address"}));
         fillClientjTable(jTable1, "");
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        int result = chooser.showOpenDialog(VENDORVIEW.this);
        ...
        if(result==JFileChooser.CANCEL_OPTION){
            ...
            ImageIcon imageIcon = new ImageIcon(new ImageIcon(filename).getImage().getScaledInstance(Vendor_Image.getWidth(), Vendor_Image.getHeight(), Image.SCALE_DEFAULT));
            Vendor_Image.setIcon(imageIcon);
    ...
    private void jButton20ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton20ActionPerformed
        Connection con = ModelLogin.getConnection();
        try {
           String path="E:\\FISE PROJECT\\Tender Managment System Final\\LOGIN\\src\\login\\VendorsImage.jrxml";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VENDORVIEW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VENDORVIEW().setVisible(true);
            }
        });
    }
